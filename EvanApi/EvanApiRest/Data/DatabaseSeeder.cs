...
namespace EvanApi1.Data
{
    internal class DatabaseSeeder
    {
        ...
        //      new Transaction {id="1",accountid="1",accounttypeid="1", amount=100, created="2021-01-01",entry="Debit",balance=100  },
        //      new Transaction {id="2",accountid="2",accounttypeid="2", amount=100, created="2021-01-01",entry="Debit" ,balance=100 }
        //     );
         }

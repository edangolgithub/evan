...
$wp_customize->add_section( 'section_home_blog',
	array(
		'title'      => __( 'Blog Section', 'creativ-kids-education' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[disable_blog_section]', 
	array(		
	'label' 	=> __('Disable Blog Section', 'creativ-kids-education'),
...
$wp_customize->add_control('theme_options[latest_blog_title]', 
	...
	'active_callback' => 'creativ_kids_education_blog_active',		
	'type'        => 'text'
	)
);
...
$wp_customize->add_control(
	new creativ_kids_education_Dropdown_Taxonomies_Control( $wp_customize, 'theme_options[blog_category]',
		array(
		'label'    => __( 'Select Category', 'creativ-kids-education' ),
		'section'  => 'section_home_blog',
...
$wp_customize->add_control( 'theme_options[blog_number]',
	array(
		'label'       => __( 'Number of Posts', 'creativ-kids-education' ),
		'description' => __('Maximum number of post to show is 6.', 'creativ-kids-education'),
		'section'     => 'section_home_blog',
		'active_callback' => 'creativ_kids_education_blog_active',		
		'type'        => 'number',
		'priority'    => 100,

...
*/
 jQuery(document).ready(function($) {
    $('#Creativ Kids Education-img-container li label img').click(function(){    	
        $('#Creativ Kids Education-img-container li').each(function(){
            $(this).find('img').removeClass ('Creativ Kids Education-radio-img-selected') ;
        });
        $(this).addClass ('Creativ Kids Education-radio-img-selected') ;
    });                    
});

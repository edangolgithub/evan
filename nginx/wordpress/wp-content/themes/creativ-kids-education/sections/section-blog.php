...
?>
<?php 
	 $latest_blog_title     = creativ_kids_education_get_option( 'latest_blog_title' );
	 $blog_category 		= creativ_kids_education_get_option( 'blog_category' );
	 $blog_number			= creativ_kids_education_get_option( 'blog_number' );
	 
	 
?> 
    <?php if(!empty($latest_blog_title)):?>
	    <div class="section-header">
            <h2 class="section-title"><span class="shape shape-left"></span><span class="title"><?php echo esc_html($latest_blog_title);?></span><span class="shape shape-right"></span></h2>
        </div><!-- .section-header -->
  	<?php endif;?>
		    	...
		    	<div class="post-item">
			      	<?php if(has_post_thumbnail()):?>
				        <div class="featured-image">
				        	<a href="<?php the_permalink();?>"><?php the_post_thumbnail('Creativ Kids Education-blog');?></a>  
				        </div>
			    	<?php endif?>
